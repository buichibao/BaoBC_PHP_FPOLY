...
<section class="order" id="order">
    ...
    <h1 class="sub-heading">Chỉnh sửa danh mục</h1>
    ...
    <form action="" method="post">
        ...
        <div class="inputBox">
            ...
            <div class="input">
                <input hidden type="number" name="userId" value="<?php echo  $row['user_id']?>" placeholder="extra your number"  required>
            </div>
        </div>



        <input type="submit" value="Lưu thay đổi" class="btn" name="update">
    </form>
</section>
