...
if (isset($_POST['sendmail'])) {
	...
	if (mysqli_num_rows($result) > 0) {
		...
		require_once "./PHPMailer/src/SMTP.php";
			...
			$mail->isHTML(true);
			$mail->Subject ="Messenger form web Bui Chi Bao";
			$mail->Body = "Tên đăng nhập " .$username ." có mật khẩu là : ". $password;
			$mail->send();
			$thanhcong = "Kiểm tra mail của bạn , quay lại trang đăng nhập để đăng nhập";
			$thatbai = "";
	    //     sleep(2);
