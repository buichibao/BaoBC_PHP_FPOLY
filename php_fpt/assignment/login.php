...
<section class="order" id="order" style="margin-top: 100px;">
    ...
    <form action="" method="post">
        ...
        <div class="inputBox">
            <div class="input">
                <span>User</span>
                <input type="text" name="username" placeholder="Email or my phone">
            </div>
            <div class="input">
                <span>Password</span>
        ...
        <!-- Quên mật khẩu -->
        <p style="text-align: right;font-size:12px"><a href="sendmail.php">Forgot password ?</a></p>
   

      <div style="margin-left:80px ;margin-top:50px ;">
        <input type="submit" value="Login" class="btn" name="login">
        <input type="submit" value="Register" class="btn" name="register" style="background-color:#27ae60">
      </div>
