...
<section class="order" id="order">
    ...
    <h1 class="sub-heading">Create Category</h1>
    ...
    <form action="" method="post">
        ...
        <div class="inputBox">
            <div class="input">
                ...
                <input type="text" name="categoryname" placeholder="enter your name" required>
            </div>
            <div class="input">
                <span>Cretate Date</span>
                <input type="date" name="createdate" placeholder="enter your createdate" required>
            </div>
        </div>
        ...
        <input type="submit" value="Create" class="btn" name="save">
    </form>
</section>
